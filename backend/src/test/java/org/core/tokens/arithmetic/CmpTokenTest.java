...
class CmpTokenTest {
    ...
    void testStackSolvingValidTokens() {
        List<IToken> tokens1 = new LinkedList<>(List.of(new IntToken(7), new IntToken(2), new CmpToken()));
        ...
        List<IToken> tokens2 = new LinkedList<>(List.of(new IntToken(2), new IntToken(7), new CmpToken()));
        ...
        List<IToken> tokens3 = new LinkedList<>(List.of(new IntToken(2), new IntToken(2), new CmpToken()));
        Stack<IToken> stack3 = new Stack<>();
        tokens3.removeFirst().stackSolving(stack3);
        assertEquals(1, stack3.size());
        assertInstanceOf(IntToken.class, stack1.peek());
        assertEquals(2, ((IntToken) stack3.peek()).getValue());
        tokens3.removeFirst().stackSolving(stack3);
    ...
    void testStackSolvingWithInvalidTokens() {
        List<IToken> tokens1 = new LinkedList<>(List.of(new BoolToken(true), new IntToken(2), new CmpToken()));
        Stack<IToken> stack1 = new Stack<>();
        tokens1.removeFirst().stackSolving(stack1);
        assertEquals(1, stack1.size());
        ...
        List<IToken> tokens2 = new LinkedList<>(List.of(new IntToken(2), new BoolToken(true), new CmpToken()));
        Stack<IToken> stack2 = new Stack<>();
        tokens2.removeFirst().stackSolving(stack2);
        assertEquals(1, stack2.size());
        assertInstanceOf(IntToken.class, stack2.peek());
    ...
    void testStackSolvingWithInsufficientTokens() {
        List<IToken> tokens1 = new LinkedList<>(List.of( new IntToken(2), new CmpToken()));
        Stack<IToken> stack1 = new Stack<>();
        ...
        List<IToken> tokens2 = new LinkedList<>(List.of(new BoolToken(true), new CmpToken()));
        Stack<IToken> stack2 = new Stack<>();
        tokens2.removeFirst().stackSolving(stack2);
        assertEquals(1, stack2.size());
        assertInstanceOf(BoolToken.class, stack2.peek());
    ...
    void testToStringOutput() {
        List<IToken> tokens1 = new LinkedList<>(List.of(new IntToken(1), new IntToken(2), new CmpToken()));
        CombinationToken combinationToken1 = new CombinationToken(tokens1);
        assertEquals("1 2 CMP", combinationToken1.toString());

        List<IToken> tokens2 = new LinkedList<>(List.of(new IntToken(2), new IntToken(1), new CmpToken()));
        CombinationToken combinationToken2 = new CombinationToken(tokens2);
        assertEquals("2 1 CMP", combinationToken2.toString());
    }
}
